...
views_to_show = c("schema","missingness","missing_rows_long","category_counts",
                  "exact_duplicates","near_duplicates","length_outliers",
                  "paired_field_check","cross_split_near_dups",
                  "paraphrase_exact_duplicate_pairs_count","paraphrase_exact_duplicates",
                  "ira_summary_Grok","ira_confusion_Grok",
                  "ira_summary_GPT5","ira_confusion_GPT5",
                  "ira_summary_Gemini","ira_confusion_Gemini",
                  "inter_summary_tbl","inter_confusion_tbls"),
